...
public:
     ...
     */
    explicit constexpr StrongId(const std::string_view str) noexcept : StrongId(fnv1a_hash(str)) {}
     ...
     */
    explicit constexpr StrongId(const StrongId_t id) noexcept : id_(id) {}
     ...
     */
    explicit constexpr StrongId(no_init_t /*unused*/) {}
...
struct std::hash<helios::core::common::types::StrongId<Tag>> {
    helios::core::common::types::StrongId_t
    operator()(const helios::core::common::types::StrongId<Tag>& id) const noexcept {
        return id.value();
    }
};