...
export module helios.core.common:Random;
...
public:
     ...
     */
    explicit Random(uint32_t seed) : gen_(seed), initialSeed_(seed) {};
    ...
    [[nodiscard]] float randomFloat(float a, float b) noexcept {
        ...
        return uniformDistFloat_(gen_, std::uniform_real_distribution<float>::param_type{a, b});
    }
    ...
    [[nodiscard]] int randomInt(int a, int b) noexcept {
        ...
        return uniformDistInt_(gen_, std::uniform_int_distribution<int>::param_type{a, b});
    }
};
