...
protected:
     ...
     */
    inline static const helios::core::log::Logger& logger_ =
        helios::core::log::LogManager::loggerForScope(HELIOS_LOG_SCOPE);
...
public:
     ...
     * @return The contents of the file as a TData object. If reading fails, a default-constructed TData is
     * returned.
     *
